			...
			<div class="container" style="margin-top: 1.5%;">	
                ...
                <div class="container">
                    ...
                    <div class="col">
                        ...
                        ?>
                        <div class="card"  style="width: 26rem; margin-bottom: 3%;">
                        <img class="card-img-top mp3-cover" src="../logo1.png" alt="Card image cap">
                        br
                        <div class="card-block">
                            ...
                            <audio controls class="mp3-auido">
                                <source src="<?php echo $dados['caminho'];?>" type="audio/mpeg">
